...
namespace UdemyRealWorldUnitTest.Test
{
    public class ProductApiControllerTest
    {
        ...
        [Theory]
        [InlineData(1)]
        public void PutProduct_IdIsNotEqualProduct_BadRequestResult(int productId)
        {
            var product = products.First(x => x.Id == productId);
        ...
        [Fact]
        public async void PostProduct_ActionExecutes_ReturnCrearedAction()
        {
        ...
        [Theory]
        [InlineData(1)]
        public async void DeleteProduct_ActionExecutes_ReturnNotContent(int productId)
        {
